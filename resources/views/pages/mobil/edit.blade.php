    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('mobil.update', $data->id) }}">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="nopol"
                                        ...
                                        value="{{ old('nopol', $data->nopol) }}" placeholder="BH 1234 XX">
                                    @error('nopol')
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="nama_sopir"
                                        ...
                                        value="{{ old('nama_sopir', $data->nama_sopir) }}" placeholder="Nama sopir">
                                    @error('nama_sopir')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="no_hp"
                                        ...
                                        value="{{ old('no_hp', $data->no_hp) }}" placeholder="08xx-xxxx-xxxx">
                                    @error('no_hp')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
