...
<head>
    <meta charset="utf-8">
    <title>Lansir Gudang - PT Sum</title>
    <style>
        * {
            margin: 18px;
            padding: 0;
    ...
    <table class="rekap">
        <thead>
            <tr class="head-group">
                ...
                <th rowspan="2" style="width:38px;">HARGA(Rp/kg)</th>
                <th rowspan="2" style="width:55px;">TOTAL HARGA (Rp)</th>
            </tr>
            <tr class="head-sub">
                ...
                @foreach ($header->kendaraans as $kendaraan)
                    ...
                    @foreach ($kendaraan->penerimas as $penerima)
                        ...
                        <tr class="{{ $rowClass }} isi">
                            ...
                            @foreach ($kodePakanList as $i => $kp)
                                @php
                                    ...
                                    if ($pakan && $pakan->jumlah_kg) {
                                        ...
                                        $totalHarga += $pakan->jumlah_kg * ($pakan->harga_pt_sum ?? 0);
                            ...
                            <td class="td-harga">{{ $totalHarga > 0 ? number_format($totalHarga, 0, ',', '.') : '-' }}
                            </td>
                        </tr>
                        @php
        ...
        <div class="kwit-outer">
            <table class="kwit-header-table">
                <tr>
                    ...
                    <td style="text-align:left; font-size:8px; color:#555; vertical-align:top;">No. {{ $noKwitansi }}
                    </td>
                </tr>
            </table>
            ...
            <table class="kwit-sign-table">
                <tr>
                    ...
                    <td>
                        <span class="kwit-sign-city">Jambi, @if ($to)
                                {{ date('d', strtotime($to)) }}
                            @endif {{ now()->translatedFormat('F Y') }}</span>
                        <span
